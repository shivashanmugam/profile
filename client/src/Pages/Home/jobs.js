export const JOB_PROPS = {
    ...
    POSITION: 'position',
    SPAN: 'span',
    DESCRIPTIVE_LIST: 'descriptive_list',
...
export const data = [{
    ...
    [JOB_PROPS.POSITION]: 'Software Engineer',
    [JOB_PROPS.SPAN]: 'June 2016 - July 2017',
    ...
    [JOB_PROPS.DESCRIPTIVE_LIST]: [
        ...
        'Helped the testing team with lot of Javascript automation ',
